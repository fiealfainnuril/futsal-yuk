...
<body>
    ...
    <div class="container" style="padding-left:0cm;">
        ...
        <h5 class="text-left">History Booking</h5>
...
Jika Status Booking = Accept , silahkan melanjutkan pembayaran ke no.rekening 123456 (Bank BNI), kemudian konfirmasi pembayaran  <br>
Jika Status Booking = Reject , artinya jam/tanggal sudah penuh, silahkan melakukan booking ulang dengan jam/tanggal berbeda <br>
Konfirmasi Pembayaran maksimal 6 jam setelah waktu pemesanan</p>
                </div>
            </div>
