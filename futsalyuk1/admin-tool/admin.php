...
$query = mysqli_query($conn, "SELECT * FROM user WHERE type_user='admin'");
?>
...
<ul>
   ...
   <div class="col-md-10" style="margin-top: 0px;">
				...
				<?php }else{ ?>
					<br>
					<a href="daftaradmin.php" class="btn btn-primary mt-3">Tambah Data</a>
					<br><br>
						...
						<tbody>
							...
							<?php while($data = mysqli_fetch_array($query)){ ?>
								<tr>
									...
									<td>
										<a href="editadmin.php?id=<?php echo $data['id']; ?>" class="btn btn-primary">Edit</a>
										<a href="delete_admin.php?id=<?php echo $data['id']; ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin?')">Delete</a>
									</td>
